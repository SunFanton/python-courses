...
print(np.where(arreglo >= 13)) # busqueda en numpy

# Filtros
filtro = [True, False, False, True, True]
print(arreglo[filtro]) # cuando se le pasa entre corchetes a un arreglo de numpy una lista u arreglo de booleanos, eso actua como filtro
...
print(pais[peso > 90], pais[peso > 90].size, "paises") # mostrar los paises con un peso promedio mayor a 90 kg
print(pais[altura > 1.8], pais[altura > 1.8].size, "paises")
print(pais[(peso > 90) & (altura > 1.8)], pais[(peso > 90) & (altura > 1.8)].size, "paises") # interseccion de ambas condiciones anteriores. Notese que solo sirve & pero no seria asi con and
print(pais[(peso > 90) | (altura > 1.8)], pais[(peso > 90) | (altura > 1.8)].size, "paises") # en el caso del 'o' solo esta definido el | pero no el or
